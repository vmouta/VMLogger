...
public struct LogChannel
{
    ...
    */
    public func trace(logger: LogConfiguration, function: String = __FUNCTION__, filePath: String = __FILE__, fileLine: Int = __LINE__)
    {
    ...
    :param:     fileLine The default value provided for this parameter captures
                ...
                not provide a value for this parameter.**
    */
    public func message(logger: LogConfiguration, msg: String, function: String = __FUNCTION__, filePath: String = __FILE__, fileLine: Int = __LINE__)
    {
        var threadID: UInt64 = 0
        pthread_threadid_np(nil, &threadID)
    ...
    :param:     fileLine The default value provided for this parameter captures
                ...
                not provide a value for this parameter.**
    */
    public func value(logger: LogConfiguration, value: Any?, function: String = __FUNCTION__, filePath: String = __FILE__, fileLine: Int = __LINE__)
    {
        var threadID: UInt64 = 0
        pthread_threadid_np(nil, &threadID)
